...
input_path = "cpp/sensor_simulator/shared/data/sensor_result.csv"
output_path = "shared/data/ai_dataset.csv"
output_path = "cpp/sensor_simulator/shared/data/ai_dataset.csv"
